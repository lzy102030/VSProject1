...
public class ActPending {
    ...
    public void actPend() {
        ...
        //获取玩家状态  0站立，1跑动，2上跳，3下跳，10拳攻击，11脚攻击, 14脸防御，15 16 17受击, 20无敌
        ...
        if (((o1xLoc - o2xLoc) < 0 && o1xHead == 1 && o2xHead == 1)               //玩家1在玩家2左边 且 1右2右时 同向   1→ 2→
            ...
            if (o2Condition == 20) {   //玩家2背向 但 无敌 时
                return;
            } else if (o1Condition == 11 || o1Condition == 10) {   //玩家1攻击时 到此 玩家2非无敌 则任意状态均受击
                attackInfoModify(1, o2Condition);
            } else {
                return;
            }
            ...
            if (o1Condition == 20) {   //玩家1背向 但 无敌 时
                return;
            } else if (o2Condition == 11 || o2Condition == 10) {   //玩家2攻击时  到此 玩家1非无敌 则任意状态均受击
                attackInfoModify(2, o1Condition);
            } else {
                return;
            }
        } else {  //对向状态的判定
            //排除判定情况[Start]
            if (o1Condition < 10 && o2Condition < 10) {     //玩家均处于非攻击/防御等状态时
                return;
    ...
    //攻击成立信息修正
    private void attackInfoModify(int player, int oPkCondition) {   //攻击有效方 受击方状态
        if (player == 1) {   //玩家1攻击有效
            o2.setHp(o2.getHp() - o1.getImpactAmt());                             //玩家2受到1攻击
            ...
            o1.setHp(o1.getHp() - o2.getImpactAmt());                             //玩家1受到攻击
